...
#define TUYA_PRODUCT_ID "gv3guzkjwsyz9da9"   // BMO Companion product (fallback; real value comes from app_default.config)
#endif

#define TUYA_OPENSDK_UUID    "uuidXXXXXXXXXXXXXXXX"             // BMO device license
#define TUYA_OPENSDK_AUTHKEY "SET_YOUR_OWN_AUTHKEY" // BMO device license
